      ...
      <div className="container">
        <div className="signin-card">
          ...
          <div className="social-buttons">
            <a href="#" className="social-btn google-btn" onClick={handleGoogleSignIn}>
            ...
            <a href="#" className="social-btn microsoft-btn" onClick={handleMicrosoftSignIn}>
              <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px'}}>
                <svg viewBox="0 0 24 24" style={{width: '18px', height: '18px'}}>
            ...
            <a href="#" className="social-btn apple-btn" onClick={handleAppleSignIn}>
              <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px'}}>
          ...
          <div className="signup-link">
            Don't have an account? <a href="/pages/Sign-up.html" onClick={handleSignUp}>Sign up here</a>
          </div>
        </div>
      </div>
    </div>
