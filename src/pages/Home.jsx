...
import HeartIcon from "../assets/icons/black-heart.png";
    ...
    <>
      ...
      <section className="section">
        ...
        <p className="section-desc">
          Our platform offers an all-in-one solution that seamlessly integrates
          recipe discovery, personalized meal planning, and organized shopping
          lists, making your cooking experience effortless and enjoyable.
        </p>
      ...
      <section className="section">
        ...
        <p className="section-desc">
          Join a community of users who have transformed their eating habits
          with our platform.
        </p>
        <div className="benefits">
          <div className="card">
            <h4 className="benefit-title" style={{ color: "#28e28b" }}>
              Saves Time
            </h4>
            <p>
              Reduce meal planning time from hours to minutes with our smart
              automation
            </p>
          </div>
          <div className="card">
            ...
            <p>
              Make better food choices with personalized nutrition
              recommendations
            </p>
          </div>
          <div className="card">
      ...
      <section className="section">
        ...
        <div className="steps">
          <div className="card">
            ...
            <p>
              Tell us about your dietary preferences, food restrictions, and
              health goals.
            </p>
          </div>
          <div className="card">
            ...
            <h4>Get Your Plan</h4>
            <p>
              Receive a personalized weekly meal plan with recipes and nutrition
              info.
            </p>
          </div>
          <div className="card">
            ...
            <h4>Shop & Cook</h4>
            <p>
              Use our auto-generated shopping list and start cooking delicious
              meals.
            </p>
          </div>
        </div>
